...
import type { MedicalTemplate } from '../data/types';
    ...
    <div className="card wide-card">
      <div className="card-header-row">
        <div>
          ...
          <p>Preview-ul de mai jos se modifică în funcție de șablonul selectat.</p>
        </div>
      </div>
      ...
      <div className="template-grid">
        {templates.map((template) => (
          ...
          >
            ...
            <button
              className={
                selectedTemplate.id === template.id ? 'btn-primary' : 'btn-secondary'
              }
              onClick={() => setSelectedTemplate(template)}
            >
              {selectedTemplate.id === template.id ? 'Șablon selectat' : 'Folosește șablon'}
            </button>
          </div>
        ))}
      </div>
    ...
    <div className="card wide-card">
      <div className="card-header-row">
        <div>
          ...
          <p>Document completat de AI. Doctorul poate modifica manual câmpurile dacă există erori.</p>
        </div>
